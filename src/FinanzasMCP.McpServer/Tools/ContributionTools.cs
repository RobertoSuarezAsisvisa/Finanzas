    ...
    GetPurchaseGoalContributionsHandler getPurchaseGoalContributionsHandler)
{
    ...
    public Task<SavingGoalSummary> AddSavingGoalContribution(Guid goalId, decimal amount, DateTimeOffset contributionDate, Guid? accountId = null, Guid? transactionId = null, CancellationToken cancellationToken = default)
    ...
    public Task UpdateSavingGoalContribution(Guid id, decimal amount, DateTimeOffset contributionDate, Guid? accountId = null, Guid? transactionId = null, CancellationToken cancellationToken = default)
        => updateSavingGoalContributionHandler.Handle(new UpdateSavingGoalContributionCommand(id, amount, contributionDate, transactionId, accountId), cancellationToken);
    ...
    public Task<PurchaseGoalSummary> AddPurchaseGoalContribution(Guid purchaseGoalId, decimal amount, DateTimeOffset contributionDate, Guid? accountId = null, Guid? transactionId = null, CancellationToken cancellationToken = default)
    ...
    public Task UpdatePurchaseGoalContribution(Guid id, decimal amount, DateTimeOffset contributionDate, Guid? accountId = null, Guid? transactionId = null, CancellationToken cancellationToken = default)
        => updatePurchaseGoalContributionHandler.Handle(new UpdatePurchaseGoalContributionCommand(id, amount, contributionDate, transactionId, accountId), cancellationToken);
